			...
			<div class="inputs " >
				<div class="text-info">
					...
					<label>NAME</label> <input type="text" placeholder="enter product name"
						name="name" value="<%=p.getName() %>" required="required"/> 
						<label class="ml-5">IMAGE</label> <input
						type="url" placeholder="give the image url" name="image" value="<%=p.getImage() %>" />


				</div>
				<div class="in">
					<label>CATEGORY</label> <input type="text"
						placeholder="enter product category" name="category" value="<%=p.getCategory() %>" required="required"/> 
						<label>STOCK</label>
					<input type="text" placeholder="enter stock quantity" name="stock" value="<%=p.getStock() %>" required="required"/>
				</div>
				<div class="d-flex row justify-content-around">
					<label>PRICE</label> <input type="number" placeholder="enter price of product"
						name="price" value="<%=p.getPrice() %>" required="required"/> 

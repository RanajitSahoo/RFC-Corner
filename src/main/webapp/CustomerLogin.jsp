...
<div class="container">
		...
		<div class="brand-subtitle">Customer Login </div>
		
		<form action="loginCustomer" method="post">
		<div class="inputs">
			<label>EMAIL</label> <input type="email" placeholder="enter email" name="email" required="required"/>
		...
		<a
			href="registerButton">Register here</a>
	</div>
		<%
	} else {

...
<body>
	...
	<div class="continer">
		...
		<marquee direction="left" behavior="scroll">Welcome mr/ms <%=c.getName().toUpperCase() %> to RFC Corner, ow your are good to go with our menu</marquee>
		<div class="row justify-content-center">
			

			<div class="col-md-3 mt-5">
				<a href="addOrder"><button class="btn-success my-2 my-lg-0 p-5" type="submit">
						Order food</button></a>
			</div>
			<div class="col-md-3 mt-5">
				<a href="viewfoodorder?cid=<%=c.getId()%>"><button class="btn-warning my-2 my-lg-0 p-5" type="submit">
						View Food Orders</button></a>
			</div>
			<div class="col-md-3 mt-5">
				<a href="viewCustomerProfile?cid=<%=c.getId()%>"><button class="btn-info  my-2 my-lg-0 p-5" type="submit">
